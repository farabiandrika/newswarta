...
<ol class="breadcrumb">
    ...
    <li class="active">
        <i class="material-icons">supervisor_account</i> {{  $title }}
    </li>
</ol>
        ...
        <div class="card">
            ...
            <div class="body">
                ...
                @endif
                    ...
                    method="POST" action="{{ url('admin/user/add') }}">
                    {{ csrf_field() }}
                    <div class="col-sm-12">
                        ...
                        <div class="form-group form-float">
                            ...
                            <input type="hidden" class="form-control" name="password" value="{{ old('password') }}"/>
            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            <tr>
                                <td><a href="{{ url('/admin/user/1') }}" class="text-success"><i class="material-icons">edit</i></a>
