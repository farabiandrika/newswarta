...
<ol class="breadcrumb">
    ...
    <li>
        <a href="{{ url('/admin/kategori') }}">
            <i class="material-icons">view_headline</i> Manajemen Kategori
        </a>
    </li>
    <li class="active">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                @endif
                @foreach ($edit as $kt)
                <form method="POST" action="{{ url('admin/kategori/'.$kt->id_kategori) }}">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                    <div class="row clearfix">
                        <div class="col-lg-7 col-md-7 col-sm-4 col-xs-7">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="nama" class="form-control" placeholder="Nama Kategori" value="{{ $kt->nama }}">
                                </div>
                            </div>
